...
void plot_rect(uint8_t* img, rect& r, uint16_t color = 0x07E0, bool show_magnitude = false);
void plot_rects(uint8_t* img, rects_t& rects, uint16_t color = 0x07E0, bool show_magnitude = false);
