...
static constexpr uint32_t period_gyro             = 20 ; // 陀螺仪 1~225Hz
...
static constexpr uint32_t period_6DOF_orientation = 20 ; // 6DOF位姿 50~255Hz
static constexpr uint32_t period_9DOF_orientation = 20 ; // 9DOF位姿 50~255Hz
